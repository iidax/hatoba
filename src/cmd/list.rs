...
pub fn run(directories: &[Directory], msg: &Msg) {
    for dir in directories {
        println!("{}", format_line(dir, msg));
    }
}

fn format_line(dir: &Directory, msg: &Msg) -> String {
...
mod tests {
    ...
    fn make_directory(path: &str, label: Option<&str>, default: bool) -> Directory {
        Directory {
            path: path.to_string(),
